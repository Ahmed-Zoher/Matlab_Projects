function [mov] = withoutincgraph(string)
% Mfile of graphs of the channelcoding without incremental redundancy  
...
for p=0.0001:0.01:0.22 %looping over different probabilities
 i=1;
   ...
   for r = 0:1:t-1
    ...
    ratio % displaying coded bit error probability
...
p=0.0001:0.01:0.22;
figure(1); % plotting of ber vs probability
plot(p,ratio);
